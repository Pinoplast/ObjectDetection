(function () {
    ...
    angular
        .module("app")
        .controller("HomeCtrl", ["$window", "fileService", "Upload", "apiUrl",
            function ($window, fileService, Upload, apiUrl) {
                ...
                function processImage(photo) {
                    fileService.processImage(photo.Name)
                        .then(function () {
